...
#'@details Warning! Entries with a "real" two digit month but a "false" one digit day will assume that the return value should be a "false" one digit month and a "real" two digit day. For example, "10/6/2016" will return "2016-01-06". Consider using the \code{mdy2mmyyy} function instead.
#'@seealso \code{mdy2mmyyy}
#'@export
#'@examples
